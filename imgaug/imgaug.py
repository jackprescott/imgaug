...
MOVED = [
    ("Keypoint", "imgaug.imgaug.augmentables.kps", None),
    ("KeypointsOnImage", "imgaug.imgaug.augmentables.kps", None),
    ("BoundingBox", "imgaug.imgaug.augmentables.bbs", None),
    ("BoundingBoxesOnImage", "imgaug.imgaug.augmentables.bbs", None),
    ("Polygon", "imgaug.imgaug.augmentables.polys", None),
    ("PolygonsOnImage", "imgaug.imgaug.augmentables.polys", None),
    ("MultiPolygon", "imgaug.imgaug.augmentables.polys", None),
    ("_ConcavePolygonRecoverer", "imgaug.imgaug.augmentables.polys", None),
    ("HeatmapsOnImage", "imgaug.imgaug.augmentables.heatmaps", None),
    ("SegmentationMapsOnImage", "imgaug.imgaug.augmentables.segmaps", None),
    ("Batch", "imgaug.imgaug.augmentables.batches", None),
    ("BatchLoader", "imgaug.imgaug.multicore", None),
    ("BackgroundAugmenter", "imgaug.imgaug.multicore", None),
    ("compute_geometric_median", "imgaug.imgaug.augmentables.kps", None),
    ("_convert_points_to_shapely_line_string", "imgaug.imgaug.augmentables.polys",
     None),
    ("_interpolate_point_pair", "imgaug.imgaug.augmentables.polys", None),
    ("_interpolate_points", "imgaug.imgaug.augmentables.polys", None),
    ("_interpolate_points_by_max_distance", "imgaug.imgaug.augmentables.polys", None),
    ("pad", "imgaug.imgaug.augmenters.size", None),
    ("pad_to_aspect_ratio", "imgaug.imgaug.augmenters.size", None),
    ("pad_to_multiples_of", "imgaug.imgaug.augmenters.size", None),
    ("compute_paddings_for_aspect_ratio", "imgaug.imgaug.augmenters.size",
     "compute_paddings_to_reach_aspect_ratio"),
    ("compute_paddings_to_reach_multiples_of", "imgaug.imgaug.augmenters.size", None),
    ("compute_paddings_to_reach_exponents_of", "imgaug.imgaug.augmenters.size", None),
    ("quokka", "imgaug.imgaug.data", None),
    ("quokka_square", "imgaug.imgaug.data", None),
    ("quokka_heatmap", "imgaug.imgaug.data", None),
    ("quokka_segmentation_map", "imgaug.imgaug.data", None),
    ("quokka_keypoints", "imgaug.imgaug.data", None),
    ("quokka_bounding_boxes", "imgaug.imgaug.data", None),
    ("quokka_polygons", "imgaug.imgaug.data", None),
]
